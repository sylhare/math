...
@app.cell
def _(arc1_color, arc2_color, arc3_color, base_layout, go, np, trefoil_xy):
...
@app.cell
def _(SCENE_THEME, base_layout, go, knot_selector, np):
...
@app.cell
def _(SCENE_THEME, base_layout, go, np):
