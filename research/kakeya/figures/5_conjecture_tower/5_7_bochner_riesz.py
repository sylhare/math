...
def main():
    ...
    axis_lw = 1.1
    for a in ax:
        a.annotate("", xy=(1.62, 0), xytext=(-1.62, 0), arrowprops=dict(arrowstyle="->", color="k", lw=axis_lw))
        a.annotate("", xy=(0, 1.28), xytext=(0, -0.06), arrowprops=dict(arrowstyle="->", color="k", lw=axis_lw))
