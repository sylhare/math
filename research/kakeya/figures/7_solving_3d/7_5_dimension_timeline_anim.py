...
# (year, plotted y, symbolic, true lower bound, name, notion)
EVENTS = [
...
def main():
    ...
    for e in range(1, len(EVENTS)):
        for s in np.linspace(0, 1, SUB, endpoint=False):
            ...
            frames.append((x, y, e))  # events 0..e-1 revealed
    ...
    def update(fi):
        ...
        ax.set_xlim(1992, 2034)  # right margin for the 2025 label
